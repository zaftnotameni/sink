...
const AUDIO_DASH : AudioStream = preload("res://zaft/lib/player/audio/dash.wav")
const AUDIO_DENY : AudioStream = preload("res://zaft/lib/player/audio/deny.mp3")
const AUDIO_DIE : AudioStream = preload("res://zaft/lib/player/audio/die.mp3")
const AUDIO_DIE2 : AudioStream = preload("res://zaft/lib/player/audio/die2.mp3")
const AUDIO_JUMP : AudioStream = preload("res://zaft/lib/player/audio/jump.mp3")
